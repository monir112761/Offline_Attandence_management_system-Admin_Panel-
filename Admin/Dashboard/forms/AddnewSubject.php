<?php
    ...
    else
    {
        ...
        if (isset($_POST['submit']))
        {
            ...
            $subjectName = strip_tags($subjectName);
        ...
        {   
            $sql = "INSERT INTO `subject`(`subjectName`) VALUES ('$subjectName')";
                ...
                {
                    $successmez = 'New Subject is successfully Added. Insert details to insert more.';
                }
                else
                {
                    /*echo 'Error'.mysqli_error($conn);*/
                    $notice = ' Enter new subject. This subject already exists';          
                }
                            ...
                            <div class="module-body">
                                    ...
                                    <br />
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="Subject" name="subjectName" placeholder="Name of the subject" class="span8"><br><br>
                                                <span class="alert alert-error" id="checkSubject" style="display: none;"></span>
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" name="submit" class="btn btn-primary btn-xl">Add Subject</button>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    function checkFields()
    {
        ...
        if (!filterName.test(Subject) || Subject.length<4)
        {
           $('#checkSubject').html("Subject name is not valid").show().delay(1000).fadeOut('slow');
        } 
    }
