                        ...
                        <div class="module">
                            ...
                            <div class="module-body table">
                                <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped  display" width="100%">
                                    ...
                                    <?php
                                      $sql = "SELECT * FROM `subject` ORDER BY `subjectId` ASC";
                                    ...
                                    ?>
                                        <tbody>
                                          <tr class="odd gradeX">
                                              ...
                                              <!-- <td class="center"><a href="../editDetails/editSubjectDetails.php?edit=1&studentRollNo=<?php echo $row->studentRollNo; ?>"><h4 style="color: #3a57af;">EDIT</h4></a></td> -->
                                          </tr>  
                                        </tbody>
                                    <?php    
                                        }
