...
<head>
    ...
    <link type="text/css" href="../../../assets/DashboardAssets/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        ...
        <link rel="stylesheet" type="text/css" href="https://code.jquery.com/jquery-1.12.4.js">
                                    ...
                                    ?>
                                        <tbody>
                                          <tr class="odd gradeX">
                                              ...
                                              <td><?php echo $row->teacherphoneNo ?></td>
                                              <td><?php echo $row->teacherEmail ?></td>
                                              <td><?php echo $row->teacherStatus ?></td>
                                              <td><?php echo $row->teacherAddress ?></td>
                                              <!-- <td class="center"><a href="../editDetails/editTeacherDetails.php?edit=1&teacherId=<?php echo $row->teacherId; ?>"><h4 style="color: #3a57af;">EDIT</h4></a></td> -->
                                          </tr>  
                                        </tbody>
                                    <?php    
                                        }
